...
int main(int argc, char *argv[]) {
  ...
  int regularId = QFontDatabase::addApplicationFont(
      ":/qt/qml/Pathfinding/ui/assets/fonts/JetBrainsMono-Regular.ttf");
  QFontDatabase::addApplicationFont(
      ":/qt/qml/Pathfinding/ui/assets/fonts/JetBrainsMono-Bold.ttf");
  if (regularId != -1) {
    QString fontFamily =
  ...
  qmlRegisterUncreatableType<Pathfinding>("App.Controller", 1, 0, "Controller",
                                          "Enums only");
  ...
  engine.rootContext()->setContextProperty("gridModel",
                                           pathfinding.gridModel());
  QObject::connect(
