...
Rectangle {
    ...
    GridView {
        ...
        delegate: GridTile {
            ...
            radius: type === 7 || type === 3 || type === 1 ? 4 : 0
            scale: isHovered ? 1.6 : (type === 7 || type === 3 || type === 1 ? 0.8 : 1.0)
            color: {
                switch (type) {
                case 0:
                    return Theme.bgGrid;
            ...
            function getRightSVG(type) {
                switch (type) {
                case 4:
                    return "../assets/svgs/startNode.svg";
                case 5:
                    return "../assets/svgs/endNode.svg";
                default:
                    return "";
                }
            }
